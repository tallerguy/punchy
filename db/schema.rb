...
ActiveRecord::Schema.define(version: 2019_03_20_202229) do
  ...
  create_table "state_changes", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["stateful_type", "stateful_id"], name: "index_state_changes_on_stateful_type_and_stateful_id"
